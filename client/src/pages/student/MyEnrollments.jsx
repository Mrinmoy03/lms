...
const MyEnrollments = () => {
  ...
  const [progressArray, setProgressArray] = useState([
    ...
    { lectureCompleted: 78, totalLecture: 78 },
    { lectureCompleted: 20, totalLecture: 50 },
    { lectureCompleted: 5, totalLecture: 5 },
    { lectureCompleted: 40, totalLecture: 100 },
    { lectureCompleted: 6, totalLecture: 20 },
  ]);
  return (
    <>
      <div className="md:pc-36 px-8 pt-10">
